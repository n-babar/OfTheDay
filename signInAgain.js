            ...
            >
                <View style={styles.modalContainer}>
                    <View style={styles.modalContent}>
                        ...
                        <TextInput placeholder="Username" placeholderTextColor="#888" style={styles.input} onChangeText={text => setUsername(text)} />
                        <TextInput placeholder="Password" placeholderTextColor="#888" secureTextEntry={true} style={styles.input} onChangeText={text => setPassword(text)} />
                        <View style={styles.buttonContainer}>
            ...
            >
                <View style={styles.modalContainerDetails}>
                    <View style={styles.modalContent}>
                        ...
                        <TextInput placeholder="First Name" placeholderTextColor="#888" style={styles.input} onChangeText={text => setFirstName(text)} />
                        <TextInput placeholder="Last Name" placeholderTextColor="#888" style={styles.input} onChangeText={text => setLastName(text)} />
                        <TextInput placeholder="Location" placeholderTextColor="#888" style={styles.input} onChangeText={text => setLocation(text)} />
                        <TextInput placeholder="Bio" placeholderTextColor="#888" style={styles.input} onChangeText={text => setBio(text)} multiline={true} />
                        <View style={styles.buttonContainer}>
